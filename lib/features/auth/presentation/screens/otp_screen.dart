...
class _OtpScreenState extends State<OtpScreen> {
  ...
  /// Resend still targets a single channel server-side even though
  /// verification itself is channel-agnostic now — default to phone when
  /// available since it's the faster round trip for the user.
  String get _resendChannel =>
      widget.registerSuccess.verificationChannels.containsKey('phone')
      ? 'phone'
      : 'email';
  ...
  void _submit(BuildContext blocCtx) {
    ...
    blocCtx.read<AuthBloc>().add(OtpSubmitted(code: code));
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OtpCountdownTimer(
                    key: _timerKey,
                    initialSeconds: widget.registerSuccess.otpExpiresInSeconds,
